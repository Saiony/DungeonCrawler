...
{
    class game_room_game_over_win_state : public base_game_room_state
    {
    public:
        explicit game_room_game_over_win_state(
        ...
        {
            return dungeon_common::enums::gameplay_state_type::game_over_win;
        }
    };
}
