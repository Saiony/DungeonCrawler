...
void dungeon_server::domain::action::holy_light::use(const std::shared_ptr<encounter>& encounter_ptr, action_log& action_log)
{
    ...
    target->take_damage(damage, action_log, encounter_ptr, action_owner_id, dungeon_common::enums::elemental_property_type::holy);
