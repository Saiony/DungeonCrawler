...
void dungeon_server::domain::action::retribution_action::use(const std::shared_ptr<encounter>& encounter_ptr, std::string& action_log)
{
    ...
    action_log +=  "\n" + action_owner->name + " used retribution - Duration: " +std::to_string(status->quantity) +" turns";
}
