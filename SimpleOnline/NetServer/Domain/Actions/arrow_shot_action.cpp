...
dungeon_server::enums::offensive_stats_type dungeon_server::domain::action::arrow_shot_action::get_offensive_stat_type()
{
    return enums::offensive_stats_type::attack_damage;
}

float_t dungeon_server::domain::action::arrow_shot_action::get_damage_variance()
{
    return 0.5f;
}

float_t dungeon_server::domain::action::arrow_shot_action::get_offensive_stat_multiplier()
{
    return 1.1f;
}

void dungeon_server::domain::action::arrow_shot_action::use(const std::shared_ptr<encounter>& encounter_ptr, action_log& action_log)
{
