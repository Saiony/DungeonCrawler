...
void dungeon_server::domain::action::provoke_action::use(const std::shared_ptr<encounter>& encounter_ptr, action_log& action_log)
{
    ...
    action_log.add_log(action_owner->name + " used " + get_name() + ". Aggro is raised for 3 turns");
}
