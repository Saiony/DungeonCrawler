...
void dungeon_server::domain::action::venomous_bite_action::use(const std::shared_ptr<encounter>& encounter_ptr, std::string& action_log)
{
    ...
    action_log += "\n" + target->name + " is poisoned [" + std::to_string(status->quantity) + "]";
