...
namespace dungeon_server::domain
{
    ...
    private:
        ...
        void end_status(const std::shared_ptr<encounter>& encounter, action_log& action_log);
    public:
        ...
        void on_attacked(const std::shared_ptr<encounter>& encounter, action_log& action_log, const std::string& attacker_id, uint16_t damage,
